...
if(!class_exists('my_pp__gatewayGateway_Paypal')){
    class my_pp__gatewayGateway_Paypal
    {
        /**
        ...
        public function __construct()
        {
            ...
            add_action( 'admin_init', array( $this, 'my_pp__gatewaycheck_version' ), 5 );
        }
        ...
        function admin_notices() {
            ...
            do_action( 'my_pp__gatewayadmin_notices', $pp_pro, $pp_payflow, $pp_standard );
        ...
        function init(){
            ...
            add_filter( 'woocommerce_payment_gateways', array($this, 'my_pp__gatewayadd_paypal_pro_gateway'),1000 );
        ...
        function woocommerce_paypal_express_init_styles() {
            global $pp_settings;
            wp_register_script( 'my_pp__gatewaybutton', plugins_url( '/assets/js/angelleye-button.js' , __FILE__ ), array( 'jquery' ), WC_VERSION, true );
            if ( ! is_admin() && is_cart()){
         ...
         *
         */
        function my_pp__gatewayadd_paypal_pro_gateway( $methods ) {
        ...
        {
            $paypal_args['bn'] = 'my_pp__gatewaySP_WooCommerce';
            return $paypal_args;
        }
        ...
        function buy_now_button() {
            ...
            {
                ?>
                <div class="my_pp__gatewaybutton_single">
                <?php
        ...
        function add_div_before_add_to_cart_button(){
            ?>
            <div class="my_pp__gatewaybuton_box_relative" style="position: relative;">
            <?php
        }
        ...
        public function my_pp__gatewaycheck_version() {
...
new my_pp__gatewayGateway_Paypal();