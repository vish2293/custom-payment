...
<form class="my_pp__gatewaycheckout" method="POST" action="<?php echo add_query_arg( 'pp_action', 'payaction', add_query_arg( 'wc-api', 'WC_Gateway_PayPal_Express_AngellEYE', home_url( '/' ) ) );?>">
...
$cancel_url = apply_filters( 'my_pp__gatewayreview_order_cance_url', $cancel_url );
echo '<div class="clear"></div>';
echo '<p><a class="button my_pp__gatewaycancel" href="' . $cancel_url . '">'.__('Cancel order', 'paypal-for-woocommerce').'</a> ';
