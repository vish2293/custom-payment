jQuery(function($) {
	...
	function update_checkout() {
		...
		var data = {
			...
			post_data:			$('form.my_pp__gatewaycheckout').serialize()
		};
		...
		xhr = $.ajax({
			...
			success: 	function( data ) {
                ...
                if ( 'failure' == data.result ) {
                    ...
                    // Form object
                    var $form = $( 'form.my_pp__gatewaycheckout' );
                    ...
                    // Scroll to top
                    $( 'html, body' ).animate( {
                        scrollTop: ( $( 'form.my_pp__gatewaycheckout' ).offset().top - 100 )
                    }, 1000 );
